        ...
        <div className='rounded-xl border px-2.5 py-3 w-72 bg-[#101204] text-[#A4AFBB]'>
            <div className='first-card'>
                <div className='flex items-center justify-between'>
                    <h1 className='ml-3 text-[#A4AFBB]'>Нужно сделать</h1>
                ...
                {isAdding ? (
                    <div className="mt-3">
                        ...
                        />
                        <button onClick={handleAddCard} className="w-full flex items-center bg-blue-400 text-black gap-2 px-3 py-1.5 justify-center rounded-md hover:bg-[#282F27]">
                            Добавить карточку
                        </button>
                    </div>
                ) : (
